...
class EachGit extends Component {
	...
	render() {
		...
		if (language == 'JavaScript') {
			this.state.check = 'fab fa-js-square fa-2x'
		} else if (language == 'Java') {
			this.state.check = 'fab fa-java fa-2x'
		} else if (language == 'HTML') {
			this.state.check = 'fab fa-html5 fa-2x'
		} else if (language == 'TypeScript') {
			this.state.check = 'fab fa-js-square fa-2x'
		} else if (language == 'C') {
			this.state.check = 'fab fa-cuttlefisgh fa-2x'
		} else {
			this.state.check = 'fas fa-code-branch fa-2x'
		}
